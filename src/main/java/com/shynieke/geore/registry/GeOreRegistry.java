...
public class GeOreRegistry {
	...
	public static final GeOreBlockReg RUBY_GEORE = new GeOreBlockReg("ruby", MaterialColor.COLOR_RED, 0xc81d2e);
	public static final GeOreBlockReg SAPPHIRE_GEORE = new GeOreBlockReg("sapphire", MaterialColor.COLOR_BLUE, 0xe00e0);
	public static final GeOreBlockReg TOPAZ_GEORE = new GeOreBlockReg("topaz", MaterialColor.GOLD, 0xffb856);
	public static final GeOreBlockReg ZINC_GEORE = new GeOreBlockReg("zinc", MaterialColor.GOLD, 0xa7bdac);
}
